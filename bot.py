...
class ModmailBot(commands.Bot):
    def __init__(self):
        ...
        self.loaded_cogs = ["cogs.modmail", "cogs.plugins", "cogs.utility", "cogs.ada_write", "cogs.ada_welcome", "cogs.ada_auto_role", "cogs.ada_yt_post", "cogs.ada_xp_message", "cogs.ada_xp_leaderboard", "cogs.ada_anti_spam"]
